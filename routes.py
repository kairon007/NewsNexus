...
def init_routes(app, db):
    ...
    @login_required
    def dashboard():
        from models import Feed, Article, Draft, Newsletter  # Lazy import
    ...
    @login_required
    def feeds():
        from models import Feed  # Lazy import
    ...
    @login_required
    def articles():
        from models import Article, Feed  # Lazy import
    ...
    @login_required
    def drafts():
        from models import Draft  # Lazy import
    ...
    @login_required
    def new_draft():
        from models import Article, Draft, Feed  # Lazy import
        if request.method == 'POST':
    ...
    @login_required
    def newsletters():
        from models import Newsletter  # Lazy import
    ...
    def schedule_newsletter():
        from models import Draft, Newsletter  # Lazy import
        if request.method == 'POST':
    ...
    def send_newsletter_now(newsletter_id):
        from models import Newsletter, Subscriber  # Lazy import
    ...
    @login_required
    def subscribers():
        from models import Subscriber  # Lazy import
    ...
    def check_scheduled_newsletters():
        from models import Newsletter, Subscriber, User  # Lazy import
        api_key = request.headers.get('X-API-Key')
        if not api_key or api_key != os.getenv('SCHEDULER_API_KEY'):
